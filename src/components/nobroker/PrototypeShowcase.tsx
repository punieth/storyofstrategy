  ...
  return createPortal(
    <div className="fixed inset-0 z-[999] flex flex-col bg-slate-950/90 backdrop-blur-sm">
      ...
      <div className="relative flex-1 overflow-auto px-2 pb-6">
        ...
        <div className="nb-shell mx-auto max-w-full nb-shell-overlay relative">
          <div className="nb-shell-inner">
            <div className="nb-theme w-full h-full rounded-3xl border border-border bg-background shadow-xl overflow-hidden" data-embedded="true">
              <NoBrokerApp embedded={true} />
            </div>
          </div>
        </div>
      </div>
...
const NoBrokerPrototypeShowcase = () => {
  const [open, setOpen] = useState(false);

  return (
    <>
      <div className="hidden md:flex justify-center">
        <div className="nb-shell nb-shell-desktop">
          <div className="nb-shell-inner">
            <div className="nb-theme w-full h-full rounded-3xl border border-border bg-background shadow-xl overflow-hidden" data-embedded="true">
              <NoBrokerApp embedded={true} />
            </div>
...
export default NoBrokerPrototypeShowcase;
