            ...
            {isLoading && (
              <div className="absolute inset-0 bg-[#0f172a] flex flex-col items-center justify-center p-4 z-30">
                <div className="flex flex-col items-center gap-3">
                  ...
                  <p className="text-[10px] font-black uppercase tracking-wider text-white">Launching ProofIt</p>
                </div>
              </div>
            )}
            ...
            {isLoading && (
              <div className="absolute inset-0 bg-[#0f172a] flex flex-col items-center justify-center p-6 z-30">
                <div className="flex flex-col items-center gap-4">
                  ...
                  <p className="text-sm font-black uppercase tracking-wider text-white">Launching ProofIt Showcase</p>
                </div>
              </div>
            )}
