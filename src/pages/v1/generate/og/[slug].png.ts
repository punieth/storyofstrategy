    ...
    <div style="display:flex; height: 100%; width: 100%; background-color: white; border: 6px solid black; border-radius: 0.5rem; padding: 2.5rem; filter: drop-shadow(8px 8px 0 rgb(0 0 0 / 1));">
      <div style="display: flex; flex-direction: column; justify-content: space-between; width: 100%;">
        <div style="display: flex; flex-direction: column;">
          ...
          <p style="font-size: 56px; font-weight: bold; margin: 0 0 16px 0; padding: 0; color: black; line-height: 1.2;">${title}</p>
          ${description ? `<p style="font-size: 28px; color: #444; margin: 0; padding: 0; line-height: 1.4;">${description}</p>` : ''}
        </div>
